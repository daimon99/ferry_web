    ...
    <el-collapse v-model="activeNames">
      <el-collapse-item :title="i18n['conventional']" name="1">
        <img
          ...
          src="https://cdn2.ihsyc.com/public/dgo2/start.svg"
          style="width:42px;height:42px;margin-top:10px"
        >
        <div>{{ i18n['startEvent'] }}</div>
        <img
          :data-item="userTaskData"
          src="https://cdn2.ihsyc.com/public/dgo2/user-task.svg"
          style="width:80px;height:44px;margin-top:10px"
        >
        <div>{{ i18n['userTask'] }}</div>
        <img
          :data-item="handleNodeData"
          src="https://cdn2.ihsyc.com/public/dgo2/receive-task.svg"
          style="width:80px;height:44px;margin-top:10px"
        >
        <div>{{ i18n['handleNode'] }}</div>
        <!-- <img :data-item="scriptTaskData"
                     src="https://cdn2.ihsyc.com/public/dgo2/script-task.svg" style="width:80px;height:44px;margin-top:10px" />
                <div>{{i18n['scriptTask']}}</div> -->
        <img
          data-item="{clazz:'end',size:'30*30',label:''}"
          src="https://cdn2.ihsyc.com/public/dgo2/end.svg"
          style="width:42px;height:42px;margin-top:10px"
        >
      ...
      <el-collapse-item :title="i18n['gateway']" name="3">
        <img
          ...
          src="https://cdn2.ihsyc.com/public/dgo2/exclusive-gateway.svg"
        ...
        <img
          ...
          src="https://cdn2.ihsyc.com/public/dgo2/parallel-gateway.svg"
          style="width:48px;height:48px;margin-top:10px"
        >
